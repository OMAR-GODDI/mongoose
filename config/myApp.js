...
var samplePerson = new Person({name: "Sample Person", age: 27, favoriteFoods: ["chicken", "water"]});
...
// 'arrayOfPeople'.
var arrayOfPeople = [
    {name: "Omar", age: 26, favoriteFoods: ["9leya"]},
    {name: "Ahmed", age: 21, favoriteFoods: ["makrouna"]},
    {name: "Alaa", age: 27, favoriteFoods: ["lablabi"]}
];
